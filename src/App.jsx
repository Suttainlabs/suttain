...
const AuthenticatedApp = () => {
  ...
  return (
    ...
    <Routes location={location} key={location.pathname}>
      ...
      <Route path="/MoleculeExplorer" element={<LayoutWrapper currentPageName="MoleculeExplorer"><Suspense fallback={<div className="flex items-center justify-center h-64"><div className="w-8 h-8 border-4 border-slate-200 border-t-teal-500 rounded-full animate-spin"/></div>}><PageTransition><MoleculeExplorer /></PageTransition></Suspense></LayoutWrapper>} />
      <Route path="/ChemicalDashboard" element={<LayoutWrapper currentPageName="ChemicalDashboard"><Suspense fallback={<div className="flex items-center justify-center h-64"><div className="w-8 h-8 border-4 border-slate-200 border-t-teal-500 rounded-full animate-spin"/></div>}><PageTransition><ChemicalDashboard /></PageTransition></Suspense></LayoutWrapper>} />
