  ...
  return (
    <section className="px-6 pt-[88px] pb-16 text-center">
      <div className="max-w-[1080px] mx-auto">
        <h1 className="font-heading font-semibold text-[clamp(34px,5.6vw,54px)] leading-[1.15] tracking-[-0.01em] text-[#0A1F1D] max-w-[760px] mx-auto mb-4">
          One platform. Two ways to work.
        </h1>
        <p className="text-[17px] text-[#4B5563] max-w-[640px] mx-auto mb-9 leading-[1.6]">
