  ...
  return (
    <section className="px-6 py-24">
      <div className="max-w-[640px] mx-auto mb-12 text-center">
        <span className="block font-mono text-xs tracking-[0.04em] text-[#02988C] mb-3">THE TOOLKIT</span>
        <h2 className="font-heading font-semibold text-[clamp(24px,3.4vw,32px)] mb-3 text-[#0A1F1D]">Real tools, not just an engine</h2>
        <p className="text-[#4B5563] text-[15.5px]">Four products, one shared chemical intelligence underneath.</p>
      </div>
      <div className="max-w-[960px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[18px]">
        {TOOLS.map((t) => (
          ...
          >
            ...
            <p className="text-[13px] text-[#4B5563] leading-[1.5]">{t.desc}</p>
          </Link>
        ))}
      </div>
    </section>
