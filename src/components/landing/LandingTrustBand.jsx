...
export default function LandingTrustBand() {
  return (
    <div className="bg-[#02988C] text-white px-6 py-[52px]">
      <div className="max-w-[1080px] mx-auto flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex gap-7 flex-wrap justify-center font-mono text-[13px] text-[#D7F5EF] tracking-[0.02em]">
          {PARTNERS.map((p) => (
            <span key={p}>{p}</span>
          ))}
        </div>
