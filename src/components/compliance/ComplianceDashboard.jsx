        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="border-b bg-gradient-to-r from-slate-50 to-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl text-slate-900">Latest Regulatory Updates</CardTitle>
                <CardDescription className="text-sm">Stay informed about recent changes</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-semibold text-slate-900">FDA Cosmetics Modernization Act</h4>
                    <Badge className="bg-green-100 text-green-700 text-xs">New</Badge>
                  </div>
                  <p className="text-sm text-slate-600 mb-2">Updated facility registration and product listing requirements now in effect.</p>
              ...
              <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-xl border border-purple-100">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-semibold text-slate-900">EU REACH Regulation Update</h4>
                    <Badge className="bg-amber-100 text-amber-700 text-xs">Updated</Badge>
                  </div>
                  <p className="text-sm text-slate-600 mb-2">New restrictions on certain substances in cosmetic products effective Q1 2025.</p>
              ...
              <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-xl border border-amber-100">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-semibold text-slate-900">California Prop 65 - New Listings</h4>
                    <Badge className="bg-blue-100 text-blue-700 text-xs">Notice</Badge>
                  </div>
                  <p className="text-sm text-slate-600 mb-2">Additional chemicals added to the Prop 65 warning list.</p>
                  <p className="text-xs text-slate-500">October 2024</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-0 shadow-lg overflow-hidden">
          <CardContent className="p-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              <div className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 transition-all cursor-pointer group">
              ...
              <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all cursor-pointer group">
                <div className="flex items-start gap-4">
