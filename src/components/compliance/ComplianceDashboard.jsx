...
const PRODUCT_IMAGES = {
  detergentRefill: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688eaf737ea3b621021f8bac/bf10a155b_close-up-view-of-female-customer-refilling-deterge-2026-01-07-01-28-58-utc.jpg",
  brightTravelPack: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688eaf737ea3b621021f8bac/61947ef64_bright-travel-pack-of-hygiene-product-mini-packag-2026-01-07-00-44-39-utc.jpg"
};
...
Generated by Suttain AI Compliance Co-Pilot
  ...
  return (
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="absolute top-40 right-0 w-72 h-72 opacity-5 pointer-events-none hidden lg:block">
        <img 
          src={PRODUCT_IMAGES.detergentRefill} 
          alt="" 
          className="w-full h-full object-cover"
        />
      </div>
      <div className="absolute bottom-20 left-0 w-56 h-56 opacity-5 pointer-events-none hidden lg:block">
        <img 
          src={PRODUCT_IMAGES.brightTravelPack} 
          alt="" 
        ...
        <Card className="border-0 shadow-lg overflow-hidden">
          <CardContent className="p-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              <Link to={createPageUrl('LearningSuite') + '?module=regulatory-compliance'} className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 transition-all cursor-pointer group block">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">Co-Pilot Guide</h3>
                    <p className="text-sm text-slate-700 mb-4">
                      Learn how to use the Compliance Co-Pilot and understand regulatory requirements
                    </p>
              ...
              <Link to={createPageUrl('FAQ')} className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all cursor-pointer group block">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">Help & FAQs</h3>
                    <p className="text-sm text-slate-700 mb-4">
                      Get answers to common questions about compliance checks and features
                    </p>
                    <Button variant="outline" className="bg-white hover:bg-slate-50 text-slate-900 border-slate-300">
                      Get Help
                    </Button>
