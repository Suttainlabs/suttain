...
import { ShieldCheck, PlusCircle, Bell, FileText, CheckCircle2, AlertTriangle, Sparkles, BookOpen, Video, Eye, Download, Settings } from 'lucide-react';
...
const ComplianceDashboard = ({ onNewCheck, onViewCheck, onSettings }) => {
  const { data: checks = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const result = await base44.entities.ComplianceCheck.list('-created_date', 10);
      return result || [];
    }
  });
  ...
  const stats = [
    ...
    { label: 'Active Checks', value: checks.length.toString(), icon: FileText, color: 'text-blue-600', bg: 'bg-blue-50' },
