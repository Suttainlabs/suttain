  ...
  const sections = [
    {
      icon: ShieldQuestion,
      title: "Introduction",
      content: "Fuelit (“we,” “our,” or “us”) is operated by Sutton Automation LLC. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use the Fuelit iOS application (the “App”).<br /><br />By using Fuelit, you agree to the collection and use of information in accordance with this policy. If you do not agree, please do not use the App."
    },
    {
      icon: Database,
      title: "Information We Collect",
      content: "<strong>Account Information</strong><br />When you create an account, we collect your name and email address. You may sign up using Apple Sign-In, Google Sign-In, or email and password. Authentication is handled by Supabase Auth.<br /><br /><strong>Profile & Dietary Preferences</strong><br />During onboarding, you provide information including age, sex, height, weight, activity level, dietary goals, goal type and pace, food allergies, ingredient exclusions, and taste preferences. This data is used to generate personalized meal plans.<br /><br /><strong>Meal Plan & Food Log Data</strong><br />We store your generated meal plans, recipes, daily food logs, and barcode scan results in our backend database to provide the core functionality of the App.<br /><br /><strong>Subscription Data</strong><br />Subscription status and purchase history are managed by RevenueCat and Apple. We receive subscription status information to determine feature access but do not process or store payment details directly.<br /><br /><strong>Usage Data</strong><br />We use Vercel Analytics on our website, which collects anonymous usage data without cookies and without collecting personal information."
    },
    {
      icon: HeartPulse,
    ...
    },
    {
      ...
      content: "Fuelit is not directed at children under the age of 13. We do not knowingly collect personal information from children under 13. If you believe a child under 13 has provided us with personal information, please contact us and we will delete it."
    },
    {
      icon: RefreshCw,
